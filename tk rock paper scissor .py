...
Label(r,text = "Rock Paper Scissor",font = "normal 20 bold",fg = "blue").pack(pady = 20)
frame = Frame(r)
frame.pack()
...
l2.pack(side = LEFT)
l3.pack()
l4 = Label(r,text = "",font = "normal 20 bold",bg = "white",width = 15 ,borderwidth = 2,relief = "solid")
l4.pack(pady = 20)    
frame1 = Frame(r)
frame1.pack()
...
Button(r, text = "Reset Game",font = 10, fg = "red",bg = "black", command = reset_game).pack(pady = 20)
